...
def iter_companies(companies):
    ...
    for company in companies:
        ...
        yield Company(
            ...
            email=fake_cn.email(),
            #phone=gen_phone_num(),
            field=choice(["移动互联网", "电子商务","金融", "企业服务", "教育", "文化娱乐", "游戏", "O2O", "硬件"]),
            finance_stage=choice(["未融资", "天使轮","A轮", "B轮", "C轮", "D轮及以上", "上市公司", "不需要融资"]),
            #fax=gen_phone_num(),
            company_info='本公司成立于'+fake.year()+'年。'+fake_cn.text(),# TODO 默认公司logo
...
def run(user_num=20, company_num=20, clearing_db=False):
    ...
    try:
        ...
        if not User.query.filter_by(username='admin').first():
            ...
            admin.email = 'admin@simplejob.com'
